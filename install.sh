...
apt update -y
apt upgrade -y
apt install apache2 php zip unzip net-tools curl mariadb-server php-mysql php-xml vnstat -y
...
yum update -y
yum install httpd php zip unzip net-tools curl mariadb-server php-mysql php-xml mod_ssl vnstat -y
